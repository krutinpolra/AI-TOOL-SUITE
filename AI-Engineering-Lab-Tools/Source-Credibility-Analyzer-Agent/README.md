...
```bash
cd AI-Engineering-Lab-Tools/Source-Credibility-Analyzer-Agent
npm install
```
...
Each run will:
- save the final Markdown report in `AI-Engineering-Lab-Tools/Source-Credibility-Analyzer-Agent/reports/`
