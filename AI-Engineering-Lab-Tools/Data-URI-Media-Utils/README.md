...
`Data URI Media Utils` is a small TypeScript utility library for encoding media files and raw bytes as Base64 Data URIs, then parsing or decoding those URIs back into bytes or files. It is designed for multimodal LLM workflows where malformed Data URIs, bad MIME types, or broken Base64 often cause frustrating bugs.
