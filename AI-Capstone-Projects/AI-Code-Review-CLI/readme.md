...
The code MUST be developed in your course git repo under `AI-Capstone-Projects/AI-Code-Review-CLI/*`.
...
Paste the link to your `AI-Capstone-Projects/AI-Code-Review-CLI/` code on GitHub. _Make sure your professor is a collaborator._
