...
The repo path in this workspace is `AI-Capstone-Projects/AI-Job-Search-Assistant/`.
...
```bash
cd AI-Capstone-Projects/AI-Job-Search-Assistant
```
...
Copy `.env.example` values into your root repo `.env` or a local `AI-Capstone-Projects/AI-Job-Search-Assistant/.env`.
...
```text
AI-Capstone-Projects/AI-Job-Search-Assistant/
├── README.md
├── .env.example
├── src/
│   ├── extract/
